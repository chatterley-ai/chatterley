...
from oumi.webchat.handlers.diffusion_handler import DiffusionHandler
...
def setup_routes(
    ...
    Args:
        ...
        diffusion_handler: Handler for diffusers-based image generation endpoints.
    ...
    oumi.post("/diffusion/generate", diffusion_handler.handle_generate_image_api)
