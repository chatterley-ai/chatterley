...
def infer(
    ...
    image_output_dir: Annotated[
        Optional[str],
        typer.Option(
            "--image-output-dir",
            help=(
                "Directory where generated images and metadata will be written. "
                "Defaults to oumi/data/gen_img."
            ),
        ),
    ] = None,
    ...
    if image_output_dir:
        parsed_config.image_output_dir = image_output_dir
