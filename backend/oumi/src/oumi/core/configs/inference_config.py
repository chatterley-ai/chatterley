...
class InferenceConfig(BaseConfig):
    ...
    image_generation: ImageGenerationParams = field(
        default_factory=ImageGenerationParams
    )
    """Parameters specific to image generation workloads."""

    image_output_dir: str = "data/gen_img"
    """Filesystem location where generated images and metadata files are stored."""
